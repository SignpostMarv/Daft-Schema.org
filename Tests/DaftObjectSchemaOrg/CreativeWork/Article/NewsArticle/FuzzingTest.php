...
namespace SignpostMarv\DaftObject\SchemaOrg\Tests\DaftObjectSchemaOrg\CreativeWork\Article\NewsArticle;
...
class FuzzingTest extends Base
{
    ...
    {
        return SchemaOrg\CreativeWork\Article\NewsArticle::class;
    }
}
