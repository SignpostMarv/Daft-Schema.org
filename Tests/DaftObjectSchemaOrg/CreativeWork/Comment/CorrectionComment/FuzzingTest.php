...
namespace SignpostMarv\DaftObject\SchemaOrg\Tests\DaftObjectSchemaOrg\CreativeWork\Comment\CorrectionComment;
...
class FuzzingTest extends Base
{
    ...
    {
        return SchemaOrg\CreativeWork\Comment\CorrectionComment::class;
    }
}
