...
namespace SignpostMarv\DaftObject\SchemaOrg\Tests\DaftObjectSchemaOrg\CreativeWork\Dataset\DataFeed;
...
class FuzzingTest extends Base
{
    ...
    {
        return SchemaOrg\CreativeWork\Dataset\DataFeed::class;
    }
}
