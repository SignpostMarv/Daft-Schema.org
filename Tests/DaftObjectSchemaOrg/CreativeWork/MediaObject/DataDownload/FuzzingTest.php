...
namespace SignpostMarv\DaftObject\SchemaOrg\Tests\DaftObjectSchemaOrg\CreativeWork\MediaObject\DataDownload;
...
class FuzzingTest extends Base
{
    ...
    {
        return SchemaOrg\CreativeWork\MediaObject\DataDownload::class;
    }
}
