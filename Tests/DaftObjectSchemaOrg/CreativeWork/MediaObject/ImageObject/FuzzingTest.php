...
namespace SignpostMarv\DaftObject\SchemaOrg\Tests\DaftObjectSchemaOrg\CreativeWork\MediaObject\ImageObject;
...
class FuzzingTest extends Base
{
    ...
    {
        return SchemaOrg\CreativeWork\MediaObject\ImageObject::class;
    }
}
