...
namespace SignpostMarv\DaftObject\SchemaOrg\Tests\DaftObjectSchemaOrg\CreativeWork\MediaObject\VideoObject;
...
class FuzzingTest extends Base
{
    ...
    {
        return SchemaOrg\CreativeWork\MediaObject\VideoObject::class;
    }
}
