...
namespace SignpostMarv\DaftObject\SchemaOrg\Tests\DaftObjectSchemaOrg\Intangible\Enumeration\QualitativeValue;
...
class FuzzingTest extends Base
{
    ...
    {
        return SchemaOrg\Intangible\Enumeration\QualitativeValue::class;
    }
}
