...
namespace SignpostMarv\DaftObject\SchemaOrg\Tests\DaftObjectSchemaOrg\Intangible\SpeakableSpecification;
...
class FuzzingTest extends Base
{
    ...
    {
        return SchemaOrg\Intangible\SpeakableSpecification::class;
    }
}
