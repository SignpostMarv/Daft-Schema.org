...
namespace SignpostMarv\DaftObject\SchemaOrg\Tests\DaftObjectSchemaOrg\Intangible\StructuredValue\InteractionCounter;
...
class FuzzingTest extends Base
{
    ...
    {
        return SchemaOrg\Intangible\StructuredValue\InteractionCounter::class;
    }
}
