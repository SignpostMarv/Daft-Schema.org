...
namespace SignpostMarv\DaftObject\SchemaOrg\Tests\DaftObjectSchemaOrg\Intangible\StructuredValue\PropertyValue;
...
class FuzzingTest extends Base
{
    ...
    {
        return SchemaOrg\Intangible\StructuredValue\PropertyValue::class;
    }
}
