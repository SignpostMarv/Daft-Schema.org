...
namespace SignpostMarv\DaftObject\SchemaOrg\Tests\DaftObjectSchemaOrg\Intangible\StructuredValue\QuantitativeValue;
...
class FuzzingTest extends Base
{
    ...
    {
        return SchemaOrg\Intangible\StructuredValue\QuantitativeValue::class;
    }
}
